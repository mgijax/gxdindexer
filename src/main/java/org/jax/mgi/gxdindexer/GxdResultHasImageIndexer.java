		...
		String mappingJson = """
		{
		  ...
		  "mappings": {
		    ...
		    "properties": {
		      ...
		      "nomenclature": { "type": "text", "analyzer": "whitespace_lower" },
		      "annotation": { "type": "keyword" },
		      "markerMgiid": { "type": "keyword" },
		      "markerSymbol": { "type": "keyword" },
		      "markerSymbolLower": { "type": "keyword", "normalizer": "lowercase_normalizer" },
		      ...
		      "resultType": { "type": "keyword", "normalizer": "lowercase_normalizer" },
		      ...
		      "structureAncestors": { "type": "keyword" },
		      "structureExact": { "type": "keyword", "normalizer": "lowercase_normalizer" },
		      "emapsId": { "type": "keyword" },
		      "structureId": { "type": "keyword" },
		      "structureKey": { "type": "keyword" },
		      "annotatedStructureKey": { "type": "keyword" },
		      "structureDescendants": { "type": "keyword" },
		      "isWildType": { "type": "keyword" },
		      "mutatedIn": { "type": "keyword" },
